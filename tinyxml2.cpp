...
{
    for (XMLNode* element = _next; element; element = element->_next)
    {
...
int XMLAttribute::QueryIntValue(int* v) const
{
    if (XMLUtil::ToInt(Value(), v))
    {
        return XML_NO_ERROR;
    }
...
int XMLAttribute::QueryUnsignedValue(unsigned int* v) const
{
    if (XMLUtil::ToUnsigned(Value(), v))
    {
        return XML_NO_ERROR;
    }
...
int XMLAttribute::QueryBoolValue(bool* v) const
{
    if (XMLUtil::ToBool(Value(), v))
    {
        return XML_NO_ERROR;
    }
...
int XMLAttribute::QueryFloatValue(float* v) const
{
    if (XMLUtil::ToFloat(Value(), v))
    {
        return XML_NO_ERROR;
    }
...
int XMLAttribute::QueryDoubleValue(double* v) const
{
    if (XMLUtil::ToDouble(Value(), v))
    {
        return XML_NO_ERROR;
    }
