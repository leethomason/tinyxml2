...
enum XMLError {
  ...
  XML_ERROR_BAD_FILE_DESCRIPTOR, // EBADF
  XML_ERROR_FILE_TOO_BIG, // EFBIG
  XML_ERROR_IO, // EIO
...
static XMLError errno2XMLError() {
  XMLError r = XML_SUCCESS;
  switch(errno) {
  case EBADF: r = XML_ERROR_BAD_FILE_DESCRIPTOR; break;
  case EFBIG: r = XML_ERROR_FILE_TOO_BIG; break;
  case EIO: r = XML_ERROR_IO; break;
  case ENOSPC: r = XML_ERROR_NO_SPACE; break;
  case EPIPE: r = XML_ERROR_PIPE; break;
  }
  return r;
}
