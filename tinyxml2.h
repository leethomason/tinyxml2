...
namespace tinyxml2
{
    ...
    */
    ...
    public:
        ...
        {
            return nullptr;    ///< Safely cast to an Element, or null.
        }

        virtual XMLText* ToText()
        {
            return nullptr;    ///< Safely cast to Text, or null.
        }

        virtual XMLComment* ToComment()
        {
            return nullptr;    ///< Safely cast to a Comment, or null.
        }

        virtual XMLDocument* ToDocument()
        {
            return nullptr;    ///< Safely cast to a Document, or null.
        }

        virtual XMLDeclaration* ToDeclaration()
        {
            return nullptr;    ///< Safely cast to a Declaration, or null.
        }

        virtual XMLUnknown* ToUnknown()
        {
            return nullptr;    ///< Safely cast to an Unknown, or null.
        }
    ...
    */
    ...
    public:
        ...
        */
        int QueryIntText(int* value) const;

        /// See QueryIntText()
        int QueryUnsignedText(unsigned* value) const;

        /// See QueryIntText()
        int QueryBoolText(bool* value) const;

        /// See QueryIntText()
        int QueryDoubleText(double* value) const;

        /// See QueryIntText()
        int QueryFloatText(float* value) const;
    ...
    */
    ...
    public:
        ...
        const XMLConstHandle LastChildElement(const char* value = nullptr) const
        {
            return XMLConstHandle(_node ? _node->LastChildElement(value) : nullptr);
        }
        ...
        const XMLConstHandle PreviousSiblingElement(const char* value = nullptr) const
        {
            return XMLConstHandle(_node ? _node->PreviousSiblingElement(value) : nullptr);
        }
        ...
        const XMLConstHandle NextSiblingElement(const char* value = nullptr) const
        {
            return XMLConstHandle(_node ? _node->NextSiblingElement(value) : nullptr);
        }
