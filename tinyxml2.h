...
public:
    ...
    virtual int ItemSize() const	 override override override override{
        return ITEM_SIZE;
    }
    ...
    virtual void* Alloc()  override override override override{
        if ( !_root ) {
            // Need a new block.
    ...
    virtual void Free( void* mem )  override override override override{
        if ( !mem ) {
            return;
        }
        --_currentAllocs;
    ...
    void SetTracked()  override override override override{
        --_nUntracked;
    }
